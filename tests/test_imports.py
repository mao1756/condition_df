...
def test_direct_package_imports() -> None:
    ...
    assert hasattr(mnist_eulerian_flux_mnist, "free_drift_flux_torch")
    assert hasattr(mnist_eulerian_flux_mnist, "step_component_rms_torch")
    assert hasattr(mnist_eulerian_flux_mnist, "edge_alpha_value")
    assert hasattr(mnist_eulerian_flux_mnist, "apply_flux_parameterization_torch")
    assert hasattr(mnist_eulerian_flux_mnist, "direct_flux_rollout_consistency_loss")
    assert hasattr(mnist_eulerian_flux_mnist, "checkerboard_energy_torch")
    assert hasattr(mnist_eulerian_flux_mnist, "flux_curl_torch")
